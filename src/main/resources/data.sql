...
INSERT INTO "TICKET" VALUES
                         (70, 1, NULL, NULL, 'member',  'Das ist ein nicht zugewiesenes Ticket', 'Ticket1', 'Das ist eine History', now(), 1, now(), 'user', '', 'registered', NULL, 61),
                         (71, 1, now(), now(), 'member', 'Das ist ein geschlossenes Ticket', 'Ticket2', 'Das ist auch eine History', now(), 0, now(), 'user2', 'Das ist die Loesung', 'closed', 64, 62),
                         (72, 1, now(), NULL, 'member', 'Das ist ein zugewiesenes Ticket', 'Ticket3', 'Das ist noch eine History', now(), 1, now(), 'user2', '', 'registered', 65, 62);
